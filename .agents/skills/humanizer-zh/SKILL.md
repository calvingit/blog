---
name: humanizer-zh
description: 去除中文文本中的 AI 写作痕迹。当用户要润色、改写、审阅中文内容，或明确要求去 AI 味、写得更自然、更像人写时使用。
---
...
如果输入是中文技术文章、博客草稿、产品说明或经验总结，额外检查下面这些高频 AI 痕迹：

1. **段末收尾总结句** - 删掉 "这说明"、"可以看出"、"到这里"、"由此可见" 这类把段落强行收死的结尾。
2. **三段式结构** - 避免 "首先...其次...最后..." 这种机械排比，改成更自然的展开顺序。
3. **升华句** - 不把具体观察拔高成空泛价值判断，比如 "这体现了工程师精神"、"这就是开源的魅力"。
4. **对比框架** - 少用 "不是...而是..."，尤其不要把它当成段落收尾句式。
5. **提示语引导** - 删掉 "值得注意的是"、"需要指出的是"、"有一点很重要" 这种提示牌。
6. **报告腔** - 少用 "本次"、"整体而言"、"综上所述"、"具体来说"、"随着...的发展"。
7. **形式感连接词** - 少用 "从而"、"进而"、"基于此"、"有鉴于此" 这类为了显得正式而加的过渡词。

处理这类文本时，优先保留信息密度、语气和判断，不要只做词语替换。
