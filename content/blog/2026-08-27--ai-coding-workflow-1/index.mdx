...
下一篇会继续讲我现在的 [Engineering Skills 日常工作流](/ai-coding-workflow-2/)，什么时候根本不需要 Skill，什么时候进入 `grilling`、`wayfinding`、`to-spec`、`quick-implement`，以及 ticket graph 出现后 `loop`、内部 worker、Runtime 和本地 artifact 各自应该负责什么。
