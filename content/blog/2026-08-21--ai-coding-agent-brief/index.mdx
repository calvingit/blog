...
[^1]: [OpenAI Codex CLI Release Notes](https://github.com/openai/codex/releases)
[^2]: [Claude Code Releases](https://github.com/anthropics/claude-code/releases)
[^3]: [AGENTS.md Specification](https://agents.md/)
[^4]: [What Keeps Agent Skills from Being Reusable?](https://arxiv.org/abs/2608.08453)
