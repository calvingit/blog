...
title: "摸鱼精选第 7 期"
slug: "摸鱼精选第7期"
description: "本期精选：C in ASM：从汇编视角分析 C 语言在 ARM64 架构下的执行机制；iOS 微信全文搜索技术优化：基于 SQLite FTS5 的引擎改进。"
date: 2022-03-15
...
经评论区网友提醒，原作者的 [C++ Reading](https://www.youtube.com/watch?v=EJtqHLvAIZE&list=PLs3KjaCtOwSZ2tbuV1hx8Xz-rFZTan2J1) 系列也很不错，都是 Modern C++的内容。
