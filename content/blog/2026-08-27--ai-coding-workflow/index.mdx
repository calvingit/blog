...
现在的做法简单很多，先看当前还缺什么，再选负责这个阶段的 Workflow，`debug`、`tdd`、`simplify`、`code-review` 这些 Engineering Discipline 按实际问题叠加。长任务则靠 `MAP.md`、`SPEC.md`、按需的 `HLD.md`、tickets 和 evidence 这些本地产物保存关键事实，不把所有状态都堆在一条越来越长的聊天记录里。
