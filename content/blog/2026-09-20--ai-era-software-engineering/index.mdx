...
在[《我的 AI Coding 工作流（二）：Skills 篇》](/ai-coding-workflow-2/)里，我回顾过把开发画成固定流水线带来的问题：局部修改也要走完整流程，需求已经清楚还要重新探索，甚至在 Skill 中重复管理 Runtime 已有的能力。那时的调整是先判断任务缺什么，再选择需要的方法，现在我还需要处理另一个实际问题：执行中发现前提变了，应该退回哪一层，又能保留哪些已经有效的工作。
