...
回看之前整理的[《Harness Engineering：Agent-First 时代的软件工程实践》](/harness-engineering-agent-first/)，我当时关注的是怎样把环境、文档、约束与反馈变成 Agent 可以使用的工程基础。继续维护自己的 Skills 后，我遇到的问题又具体了一层：这些规则本身也有维护成本，哪些值得保留，哪些应该交给项目环境或 Runtime，哪些已经可以删掉？本文记录的是这段实践形成的认识，其中有已经观察到的收益，也有下一步准备验证的方向，还不能把它们当成一套已经解决所有问题的方法。
